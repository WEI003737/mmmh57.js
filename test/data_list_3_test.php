...
<!--                <a href="" datd-cate="1" onclick="goPage(1)">cate1</a>-->
<!--                <a href="" datd-cate="2" onclick="goPage(1)">cate2</a>-->
<!--                <a href="" datd-cate="3" onclick="goPage(1)">cate3</a>-->
            </div>
        </div>
...
<?php include __DIR__ . '/part/scripts.php' ?>
    <script>
        ...
        */
        ...
        const cateTpl = cate =>{
            return`
            <a href="" class="cate" datd-cate="${cate}" onclick="goPage(1)">cate${cate}</a>
            `
        };
      ...
      `;
        ...
        function getDataByPage(page=1, keyword='', cate='') {
            $.get('data_list_3_api.php', {page:page, keyword:keyword, cate:cate }, function(data){
                console.log(data)
                let cStr = '';
                for(let i=1; i<=3; i++){
                    cStr += cateTpl(i)
                }
                categories.html(cStr);
        ...
        function whenHashChange(){
            ...
            if(page){
                getDataByPage(page, keyword, cate);
            } else {
                getDataByPage(1, keyword, cate);
            }
        };
        ...
        $(document).on("click", "cate", function(){
            cateSid = $(event.target).attr("data-cate")
            console.log("click")
        });
