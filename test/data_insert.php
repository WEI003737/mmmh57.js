            ...
            <div class="col">
                <form method="post">
                    <div class="form-group">
                        ...
                        <small id="item_name_help" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        ...
                        <small id="item_num_help" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        <label for="color">color</label>
                        <input type="text" class="form-control" id="color" name="color" required
                               value="<?= isset($_POST['color']) ? htmlentities($_POST['color']): '' ?>">
                        <small id="color_help" class="form-text text-muted"></small>
                    </div>
                    <div class="form-group">
                        ...
                        <small id="color_num_help" class="form-text text-muted"></small>
                    </div>
